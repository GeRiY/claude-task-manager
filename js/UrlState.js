 ...
 * Deep-link parameters: ?project=&lang=&task=<id>&agent=&module=&sort=&view=&agroup=&compact=1
...
export class UrlState {
  ...
  static read() {
    ...
    return {
      ...
      agroup: p.get("agroup") || localStorage.getItem("tm.agroup") || "day",
  ...
  static sync({ agentFilter, moduleFilter, sort, view, compact, openTaskId, project, lang, agroup }) {
    ...
    if (view === "archive" && agroup && agroup !== "day") p.set("agroup", agroup);
  ...
  static setAgroup(v) { localStorage.setItem("tm.agroup", v); }
